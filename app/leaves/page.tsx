...
export default function LeavesPage() {
  const { rows, loading, update, create, removeMany } = useResourceRows('leave_records');
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <TableToolbar title="请假管理" columns={TOOLBAR_COLS} hidden={hidden} onToggleColumn={toggle} rows={rows} onAdd={() => setAddOpen(true)} selectedKeys={selected} onBatchDelete={() => setBatchIds([...selected])} />
